...
housing-versus-everything-else gap is the widest of the five metros compared
here, ahead of Dallas \NColRppGapDallas, Nashville \NColRppGapNashville\ and
Houston \NColRppGapHouston, with San Antonio showing essentially no gap at
...
category priced well above the national norm in Austin. The rest of this
...
Austin musicians look better placed than the typical Austin worker. The
reason is coverage, not prosperity: the OEWS payroll wage describes only the
\NEmpPayrollMusiciansAustinLast\ musician jobs the 2025 OEWS Austin sample
recorded, the measurement gap Section~\ref{sec:measurement} describes, and
those few payroll jobs pay above the
