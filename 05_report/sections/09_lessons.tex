...
in the section listed, and every underlying figure is registered in the
study's numbers ledger, which accompanies the analysis files.
...
pandemic, 2 regulatory, 3 uncoded, 5 other). The presenter
...
presenters. Sources: the study's venue-closure news timeline; census
